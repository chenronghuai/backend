...
class TestFlightsManage(unittest.TestCase, metaclass=TestMeta):
    ...
    def test_add_flihgts(self, center, line, seat_num):
        ...
        self.fm.add_flight(center, line, flight_no, seat_num, depart_date, depart_time)
        WebDriverWait(self.fm.driver, 5).until(
            EC.presence_of_element_located((By.CSS_SELECTOR, 'div[type="dialog"]')))
        WebDriverWait(self.fm.driver, 5).until(EC.invisibility_of_element_located((By.CSS_SELECTOR, 'div[type="dialog"]')))
